export const projectData = [
  {
    ...
    title: "Personal Blog",
    about:
      "Designed my personal website to give a brief overview of myself and mywork experience.",
    tags: ["React JS", "NPM", "Bootstrap", "CSS", "HTML"],
    demo: "www.demoproject.com",
  ...
  },
  {
    ...
    about:
      "To enhace my skills I build personal projects and capstone projects which I commit to github (above link) in React Js along with other technologies like bootstrap, css, MUI, npm and designing tools which helps to provide awesome look.",
    tags: ["React JS", "Redux", "NPM", "JavaScript", "CSS", "HTML"],
    demo: "https://github.com/raghu-chikka",
